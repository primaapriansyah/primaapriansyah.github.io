			...
			<div class="col-md-10">
				...
				<div class="col-md-9">
					<div class="page-header text-center headerCustom">
						<h4 class="title-category">Interest Auction</h4>
					</div>
					<div class="row content-profile">
						...
						<div class="col-md-9">
							<h5 class="bs-callout bs-callout-warning bs-callout-custom">PT Pertamina Persero <a href="#" type="button" class="btn btn-primary btn-xs" style="float:right;">Edit Interest Auction</a></h5>
							<table class="table table-user-information">
								<tbody>
								  <tr>
									<td class="col-md-3">Bidang Usaha</td>
									<td>Manufaktur</td>
								  </tr>
								  <tr>
							...
							<a href="#" type="button" class="btn btn-primary btn-sm">+ Tambah Interest Auction</a>
						</div>
					</div>
