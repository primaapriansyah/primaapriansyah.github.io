			...
			<div class="col-md-10">
				...
				<div class="col-md-9">
					<div class="page-header ph-custom">
						<h4 id="whats" class="title-category">Pemberitahuan Anda</h4>
						<small><cite>" Easiest way to buy, Highest price to sell "</cite></small>
					</div>
					
					<div class="row row-cols9">
						<div class="panel panel-default notif_panel">
							<!-- Default panel contents -->
							<div class="panel-heading notif_panel_heading">Pemberitahuan Anda <a href="#" type="button" class="btn-group btn-group-sm notif_panel_a">Setting Pemberitahuan</a></div>
							<!-- List group -->
							<ul class="list-group">
								<li class="list-group-item">
									<div class="media">
										...
										<div class="media-body">
											<a href="#"><p class="media-heading f13">Private bidder telah memasukkan Bid ke <code>Lelang mobil Avanza thn 2012</code> sebesar <code>Rp 180.000.000</code></p></a>
