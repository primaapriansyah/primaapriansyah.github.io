					...
					<ul class="nav navbar-nav nav-tab ">
								...
								<li>
									...
									<ul class="menu">
										...
										<a href="#" class="colornotif">
											<i class="fa fa-bullhorn"></i>Congratulation! You are the Winner for this Auction.<br>
						...
						<li class="dropdown user user-menu list-notif">
							...
							<ul class="dropdown-menu notifdash">
								...
								<li><a href="../create_auction_c2c.jsp">Buat Lelang</a></li>
		...
		<div class="row">
			...
			<div class="col-md-10">
				...
				<div class="col-md-3 inner_cat" role="complementary">
					<nav class="bs-docs-sidebar">
						...
						<div class="panel-group" id="accordion">
							...
							<div class="panel panel-default panel-custom panelLeft_style dashboard_leftside">
								<div class="panel-heading dashboard_leftside_heading">
									<a href="../create_auction_c2c.jsp" class="sidebar_menufont">
							...
							<div class="panel panel-default panel-custom panelLeft_style dashboard_leftside">
								<div class="panel-heading dashboard_leftside_heading">
									<a href="MyProfile_c2c_new.jsp" class="sidebar_menufont">
									...
									<div class="panel-body dashboard_dropd">
										<table class="table table-font">
											<tbody><tr>
												<td class="modif_td">
													<span class="fa fa-cart-arrow-down fa-space"></span>
													<a class="subsidebar_menufont" href="active_auction_c2c_new.jsp">Lelang Aktif<span class="badge badgesCustom">1</span></a>
												</td>
											</tr>
											<tr>
												<td class="modif_td">
							...
							<div class="panel panel-default panel-custom panelLeft_style dashboard_leftside">
								<div class="panel-heading dashboard_leftside_heading">
									<a href="payment_info.jsp" class="sidebar_menufont">
							...
							<div class="panel panel-default panel-custom panelLeft_style dashboard_leftside">
								<div class="panel-heading dashboard_leftside_heading">
									<a href="donasi.jsp" class="sidebar_menufont">
				...
				<div class="col-md-9" role="main">
					<div class="bs-docs-section" style="margin-bottom:80px;">
						<div class="page-header" style="margin-top:0px !important;">
							<h4 id="whats" class="title-category">Selamat Datang Dena S Anandika!</h4>
							<small><cite>Nikmati pengalaman lelang yang membuat barang bekasmu memiliki nilai jual dan manfaat yang lebih bersama Waterbe.</cite></small>
						</div>
							...
							<div class="bs-glyphicons">
								<ul class="bs-glyphicons-list">
									<li>
										...
										<a href="active_auction_c2c_new.jsp" class="link-dash">
											<span class="glyphicon-class">81 Lelang</span>
											<p class="desc-dash">Tingkatkan terus lelang anda lorem ipsum dolor sitamet</p>
										</a>
									</li>
									
									<li>
										<i class="fa fa-cart-plus fa-3x"></i>
										<a href="bid_aktif_c2c.jsp" class="link-dash">
											<span class="glyphicon-class">62 Bid</span>
											<p class="desc-dash">Tingkatkan terus lelang anda lorem ipsum dolor sitamet</p>
										</a>
									</li>
									<li>
										<i class="fa fa-cart-plus fa-3x"></i>
										<a href="donasi.jsp" class="link-dash">
											<span class="glyphicon-class">Donasi IDR 32.000.000</span>
											<p class="desc-dash">Tingkatkan terus lelang anda lorem ipsum dolor sitamet</p>
										</a>
									</li>
									<li>
										<i class="fa fa-edit fa-3x"></i>
										<a href="../create_auction_c2c.jsp" class="link-dash">
											<span class="glyphicon-class">Buat Lelang</span>
											<p class="desc-dash">Tingkatkan terus lelang anda lorem ipsum dolor sitamet</p>
										</a>
									</li>
									<li>
										<i class="fa fa-thumbs-o-up fa-3x"></i>
										<a href="MyProfile_c2c_new.jsp" class="link-dash">
											<span class="glyphicon-class">Akun Saya</span>
											<p class="desc-dash">Tingkatkan terus lelang anda lorem ipsum dolor sitamet</p>
										</a>
									</li>
									<li>
										<i class="fa fa-question fa-3x"></i>
										<a href="#" class="link-dash">
											<span class="glyphicon-class">Bantuan</span>
											<p class="desc-dash">Tingkatkan terus lelang anda lorem ipsum dolor sitamet</p>
										</a>
									</li>
								</ul>
