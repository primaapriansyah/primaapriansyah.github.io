			...
			<div class="col-md-10">
				<div class="row">
					<ol class="breadcrumb breadcrumb-style">
						...
						<li class="active">Tidak Menang Bid</li>
					</ol><!-- End Breadcrumb -->
				</div>
			</div>
			<div class="col-md-1"></div>
				...
				<div class="col-md-9" role="main">
					<div class="bs-docs-section bidaktif_SideRight">
						<div class="page-header nomargintop">
							<h4 id="whats" class="title-category">Tidak Menang Bid</h4>
						...
						<div class="media">
							...
							<div class="media-body">
								...
								<div class="btn-group btn-group-sm bidaktif_elapsed f11">
									<p class="bidaktif_elapseddet"><code>Status Pelelangan : Tidak Menang</code></p> 
								</div>
											...
											<table class="table f11">
												<tbody>
													<tr>
														...
														<td class="modif_td"><a href="#">: 76 Bid</a></td>
													</tr>
													<tr>
													...
													<tr>
														<td class="modif_td">Bid Pemenang</td>
								...
								<a href="#" type="button" class="btn btn-success btn-sm">Tambahkan sebagai Pantauan</a>
							</div>
						</div>
					</div>
				</div>
