		...
		<div class="row">
			...
			<div class="col-sm-10 col-md-10">
				<div class="row" style="margin-right:0px !important;">
					<h3 class="hot-auction-label"><span>All Bid</span></h3>
					<table id="example" class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%">
						...
						<tbody>
							<tr>
								...
								<td>Kapal Tanker Pertamina fgdjf</td>
								<td>PT Pertamina Persero</td>
								<td><a href="#" data-toggle="modal" data-target="#myModal">List of Buyer</a></td>
								<td>11-7-2015</td>
								<td><span class="badge bg-red">25.000.000.000.</span></td>
								<td><a href="#" class="text-center" style="display:block;">Bid</a></td>
							</tr>
							<tr>
								<td><a href="detail_tomjer.html">132671</a></td>
								<td>Kapal Tanker Pertamina fgdjfhsjf </td>
								<td>PT Pertamina Persero</td>
								<td><a href="#" data-toggle="modal" data-target="#myModal">List of Buyer</a></td>
								<td>11-7-2015</td>
								<td><span class="badge bg-red">25.000.000.000.</span></td>
