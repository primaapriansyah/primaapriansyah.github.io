				...
				<div class="col-md-9">
					<div class="row">
						<div class="page-header text-center headerCustom">
							<h4 class="title-category">Edit Interest Auction</h4>
						</div>
						<div class="row content-profile">
							...
							<div class="col-md-9">
								<h5 class="bs-callout bs-callout-warning bs-callout-custom">PT Pertamina Persero</h5>
								<form class="form-horizontal">
								  <div class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label control-label-custom">Bidang Usaha</label>
									<div class="col-sm-8">
								  ...
								  <div class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label control-label-custom">Kategori Barang</label>
									<div class="col-sm-8">
										<select class="form-control">
										  <option>Manufaktur</option>
										  <option>Banking</option>
								  ...
								  <div class="form-actions" style="margin-bottom:40px;">
										<a href="#" class="btn btn-success btn-sm save">Save</a>
										<a href="#" class="btn btn-default btn-sm">Cancel</a>
								  </div>
								</form>
								<a href="#" type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal">+ Tambah Interest Auction</a>
									  ...
									  <div class="modal-body">
										<form class="form-horizontal">
										  <div class="form-group">
											<label for="inputEmail3" class="col-sm-3 control-label control-label-custom">Bidang Usaha</label>
											<div class="col-sm-8">
											  <input type="email" class="form-control" id="inputEmail3" placeholder="Bidang Usaha">
											</div>
										  </div>
										  <div class="form-group">
											<label for="inputEmail3" class="col-sm-3 control-label control-label-custom">Kategori Barang</label>
											<div class="col-sm-8">
											  <input type="email" class="form-control" id="inputEmail3" placeholder="Kategori Barang">
											</div>
										  </div>
										</form>
									  </div>
