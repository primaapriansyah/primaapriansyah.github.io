		...
		<div class="row">
			...
			<div class="col-md-9">
				<div class="page-header text-center headerCustom">
					<h4 class="title-category">Edit My Rekening</h4>
				</div>
					...
					<div class="col-sm-9 col-md-9">
						...
						<form class="form-horizontal">
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-8">
							  <input type="email" class="form-control" id="inputEmail3" placeholder="Nomor Rekening">
							</div>
						  </div>
						...
						<a href="#" type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal">+ Tambah Rekening Bank</a>
