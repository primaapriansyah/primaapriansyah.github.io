...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Payment for Bidder</title>
					...
					<div id="collapseEight" class="panel-collapse collapse">
						<div class="panel-body">
							<table class="table table-font">
								<tr>
									<td>
										<span class="fa fa-buysellads fa-space"></span><a href="#">Payment for Bidder</a>
									</td>
								</tr>
								<tr>
									<td>
				...
				<div class="col-md-9">
					<div class="row">
						<div class="page-header text-center headerCustom">
							<h4 class="title-category">Menangkan Semua Bid Anda segera!</h4>
						</div>
						...
						<div class="row" style="margin-bottom:30px;margin-left:-3px;">
							...
							<div class="col-md-3" style="padding-right:0;padding-left: 3px;">
								<select class="form-control form-control_custom" style="font-size:13px;">
									...
									<option>Belum Bayar Uang Jaminan</option>
									<option>Belum Bayar Pelunasan</option>
									<option>Pengembalian Uang Jaminan</option>
									<option>Transaksi Terkirim</option>
									<option>Konfirmasi Pembayaran</option>
									<option>Pick up money</option>
									<option>Verifikasi transaksi</option>
									<option>Transaksi Selesai</option>
									<option>Konfirmasi Transaksi</option>
								</select>
							</div>
						...
						<div class="table-responsive tablefont">
							...
							<thead>
								<tr>
									...
									<th class="text-center vertable">Durasi</th>
									<th class="text-center vertable">Harga Pembuka</th>
									<th class="text-center vertable">Pembayaran</th>
									<th class="text-center vertable">Status Payment</th>
									<th class="text-center vertable">Status Bidder</th>
									<th class="text-center vertable">Action</th>
								</tr>
							</thead>
							<tbody>
								<tr data-toggle="collapse" data-target="#demo1" class="accordion-toggle">
									...
									<td>27 Juli 2015 - 11 Agustus 2015</td>
									<td class="text-success">Rp 85.000.000</td>
									<td class="text-success">Rp 15.000.000</td>
									<td><code>Belum Bayar Uang Jaminan</code></td>
									<td><code>Inactive</code></td>
									<td><a href="#">Cek Metode Pembayaran</a></td>
								</tr>
								<tr>
										...
										<div class="accordian-body collapse Hidden_accorbid" id="demo1">
											<div>
												...
												<div class="media-body">
													<strong class="text-danger">Informasi Lelang</strong>
													<table class="table table-user-information" style="font-size: 11px;">
														<tbody>
														  ...
														  <tr>
															<td>Status Lelang</td>
															<td><code>Pre Auction</code></td>
														  </tr>
														  <tr>
															<td>Waktu tersisa Pembayaran Uang Jaminan</td>
															<td>04 Hari:12 Jam:34 Menit</td>
														  </tr>
														</tbody>
													</table>
													<a href="#" type="button" class="btn btn-info btn-sm">Lihat Selengkapnya</a>
													<a href="#" type="button" class="btn btn-success btn-sm">Konfirmasi Pembayaran</a>
													<a href="#">Cek Metode Pembayaran?</a>
												</div>
											</div>
											<table class="table table-hover" style="margin-top:30px;">
												...
												<tbody>
													<tr>
													  ...
													  <td>Bidder sudah melakukan pengecekan pengembalian uang jaminan dan sudah diterima</td>
													</tr>
													<tr>
													  <th scope="row">29 Juli 2015 15:20</th>
													  <td><code>Bidder</code></td>
													  <td>Verifikasi Pembayaran</td>
													  <td>Bidder melakukan verifikasi pembayaran pengembalian uang jaminan</td>
													</tr>
													<tr>
													  <th scope="row">28 Juli 2015 12:20</th>
													  <td><code>System</code></td>
													  <td>Pengembalian Uang Jaminan</td>
													  <td>Sistem mengirim pengembalian uang jaminan</td>
													</tr>
													<tr>
													  <th scope="row">22 Juli 2015 12:20</th>
													  <td><code>System</code></td>
													  <td>Verifikasi Pembayaran</td>
													  <td>Sistem memverifikasi pembayaran uang jaminan bidder</td>
													</tr>
													<tr>
													  <th scope="row">22 Juli 2015 10:20</th>
													  <td><code>System</code></td>
													  <td>Konfirmasi Pembayaran</td>
													  <td>Bidder konfirmasi pembayaran uang jaminan</td>
													</tr>
													<tr>
													  <th scope="row">20 Juli 2015 10:20</th>
													  <td><code>Bidder</code></td>
													  <td>Belum bayar uang jaminan</td>
													  <td>Bidder belum membayar uang jaminan</td>
													</tr>
												</tbody>
												</table>
										</div> 
