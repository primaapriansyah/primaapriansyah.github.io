				...
				<div class="col-md-9" role="main">
					<div class="bs-docs-section bidaktif_SideRight">
						<div class="page-header nomargintop">
							<h4 id="whats" class="title-category">Informasi Pembayaran</h4>
						...
						<div class="row bidaktif_FormSearch">
							...
							<div class="col-md-2 bidaktif_FormSearchFil">
								<div class="controls">
									<div class="input-group">
						...
						<div class="media">
							...
							<div class="media-body">
								<div>
									<a href="#" class="bidaktif_Title f15">Kapal Tanker Pertamina Lokasi Ujung Berung</a>
								</div>
								<div class="btn-group btn-group-sm bidaktif_elapsed f11">
									<p class="bidaktif_elapseddet">Seller : karno_sh</p> 
									<p class="bidaktif_elapseddet">|</p> <p class="bidaktif_elapseddet">Nomor Resi : CGKAE08380502815</p>
								</div>
									...
									<div class="col-md-6">
										<div class="table-responsive">
											<table class="table f11">
												<tbody>
													<tr>
														<td class="modif_td">Nomor Invoice</td>
														<td class="modif_td">: <a href="#">INV/20150909/XV/IX/17258675</a></td>
													</tr>
													<tr>
														<td class="modif_td">Tanggal Transaksi</td>
														<td class="modif_td">: 09 September 2015</td>
													</tr>
													<tr>
														<td class="modif_td">Jumlah Pembayaran</td>
														<td class="modif_td">: 47.000.000</td>
													</tr>
												</tbody>
											</table>
										</div>
									...
									<div class="col-md-6">
										<div class="table-responsive">
											<table class="table f11">
												<tbody>
													<tr>
														<td class="modif_td">Alamat Tujuan</td>
														<td class="modif_td">: Perum Bumi Sani Permai
															Blok E1 No.14, RT 12 RW 14
															Tambun Selatan, Kab. Bekasi, 17510
															Jawa Barat
															Telp: 081298436061</td>
													</tr>
													<tr>
														<td class="modif_td"></td>
														<td class="modif_td"><a href="#" data-toggle="modal" data-target="#myModal" >History Transaksi</a></td>
													</tr>
												</tbody>
											</table>
										</div>
