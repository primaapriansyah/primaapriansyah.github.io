				...
				<div class="col-md-9">
					<div class="row">
						<div class="page-header text-center headerCustom">
							<h4 class="title-category">Daftar Lelang tidak terjual!</h4>
						</div>
						...
						<div class="table-responsive tablefont">
							...
							<tbody>
								<tr data-toggle="collapse" data-target="#demo1" class="accordion-toggle">
									...
									<td>Rp 85.000.000</td>
									<td><a href="../bidder_page.jsp">0 Bid</a></td>
										...
										<div class="accordian-body collapse Hidden_accorbid" id="demo1">
											<div>
												...
												<div class="media-body">
													...
													<a href="../buat_lelang_c2c.jsp" type="button" class="btn btn-danger btn-sm">Lelang Kembali</a>
												</div>
											</div>
										</div> 
									</td>
