...
<body>
    ...
    <div class="container-fluid">
		...
		<div class="col-sm-10 col-md-10">
			<div class="row">
				<h3 class="hot-auction-label"><span>Loss Opportunity Bid</span></h3>
				<div class="col-md-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Loss Opportunity Bid</h3>
                </div><!-- /.box-header -->
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    <tbody><tr>
                      <th class="col-md-2">ID Auction</th>
                      <th class="col-md-2">Auction Name</th>
                      <th class="col-md-2">Seller</th>
					  <th class="col-md-2">Location</th>
					  <th class="col-md-2">Closing Price</th>
                    ...
                    <tr>
					  ...
					  <td>Blok Mahakamcxcxcx dfdkfjd ijfdkjfdf kjfkdjfdkjfdf kjfkdjfdkfkdf kjkfjdfjdkfd </td>
					  <td>15.000.000.000</td>
					  <td>11 April 2015 - 22 April 2015</td>
					  <td><a href="#"><button type="button" class="btn btn-primary btn-sm" style="width:100%;">Add to Watch List</button></a></td>
                    </tr>
                  </tbody>
				  </table>
                </div><!-- /.box-body -->
