...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Lelang Tidak Terjual</title>
			...
			<div class="col-md-10">
				<div class="row">
					<ol class="breadcrumb breadcrumb-style">
						...
						<li class="active">Lelang Tidak Terjual</li>
					</ol><!-- End Breadcrumb -->
				</div>
			</div>
			<div class="col-md-1"></div>
				...
				<div class="col-md-9" role="main">
					<div class="bs-docs-section bidaktif_SideRight">
						<div class="page-header nomargintop">
							<h4 id="whats" class="title-category">Lelang Tidak Terjual</h4>
						...
						<div class="media">
							...
							<div class="media-body">
											...
											<table class="table f11">
												<tbody>
													<tr>
														...
														<td class="modif_td"><a href="#">: 0 Bid</a></td>
													</tr>
													<tr>
								...
								<a href="../buat_lelang_c2c_new.jsp" type="button" class="btn btn-success btn-sm">Lelang Kembali</a>
								<a href="draft_auction_c2c.jsp" type="button" class="btn btn-warning btn-sm">Masukan ke Draft Lelang</a>
							</div>
						</div>
					</div>
				</div>
