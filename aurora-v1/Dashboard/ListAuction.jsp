						...
						<div class="table-responsive tablefont">
							...
							<tbody>
								<tr data-toggle="collapse" data-target="#demo1" class="accordion-toggle">
									...
									<td>2 Hari:22 Jam:16 Menit</td>
									<td><code>Waiting for BAST</code></td>
								</tr>
								<tr>
												...
												<div class="media-body">
													...
													<table class="table table-user-information" style="font-size: 11px;">
														<tbody>
														  ...
														  <tr>
															<td>Lampirkan BAST</td>
															<td>
																<input type="file" id="lampiranBAST">
															</td>
														  </tr>
														</tbody>
													</table>
													<a href="#" type="button" class="btn btn-info btn-sm">Lihat Selengkapnya</a>
													<a href="#" type="button" class="btn btn-success btn-sm">Konfirmasi BAST</a>
												</div>
											</div>
										</div> 
									</td>
