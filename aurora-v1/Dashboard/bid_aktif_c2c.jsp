				...
				<div class="col-md-9" role="main">
					<div class="bs-docs-section bidaktif_SideRight">
						<div class="page-header nomargintop">
							<h4 id="whats" class="title-category">Bid Aktif Anda</h4>
						...
						<div class="row bidaktif_FormSearch">
							...
							<div class="col-md-3 bidaktif_FormSearchFil">
								<select class="form-control form-control_custom f13">
									<option>Status Bid</option>
									<option>Highest Bidder</option>
									<option>Outbid</option>
								</select>
							</div>
							<div class="col-md-3 bidaktif_FormSearchFil">
								<select class="form-control form-control_custom f13">
									<option>Urutkan Waktu Bid</option>
									<option>Bid Terbaru</option>
									<option>Bid Akan Berakhir</option>
								</select>
							</div>
						...
						<div class="media">
							<div class="media-left">
								<a href="#">
								  <img class="media-object" data-src="holder.js/64x64" alt="32x32" src="../img/building/gedungpre3.jpg" data-holder-rendered="true" style="width: 64px; height: 64px;">
								</a>
							</div>
							<div class="media-body">
								<div>
									<a href="../detail_lelang_c2c.jsp" class="f15 bidaktif_Title">Ruko dengan Luas Bangunan 200 M2, Lokasi Strategis daerah Kelapa Gading</a>
								</div>
											...
											<table class="table f11">
												<tbody>
													<tr>
														...
														<td class="modif_td">: <a href="bidder_page.jsp">18 Bid</a></td>
													</tr>
													<tr>
														<td class="modif_td">Bid Anda</td>
														<td class="modif_td">: 2.000.000.000</td>
													</tr>
													<tr>
														<td class="modif_td">Bid Saat ini</td>
														<td class="modif_td">: 2.020.000.000</td>
													</tr>
													<tr>
														<td class="modif_td">Status Bid</td>
														<td class="modif_td">: <code>Outbid</code></td>
													</tr>
												</tbody>
											</table>
										</div>
											...
											<table class="table f11">
												<tbody>
													...
													<tr>
														...
														<td class="modif_td">:  Jakarta Utara</td>
													</tr>
													<tr>
														<td class="modif_td">Donasi</td>
														<td class="modif_td">: 10% <a href="#">[Palang Merah Indonesia]</a></td>
													</tr>
													<tr>
														<td class="modif_td">Waktu Tersisa</td>
														<td class="modif_td">: 9 hr 12 jam 36 mnt</td>
													</tr>
												</tbody>
											</table>
										</div>
								...
								<form class="form-inline">
									...
									<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target=".bs-example-modal-sm">Bid</button>
								</form>
							</div>
					</div>
					...
					<div class="media">
							...
							<div class="media-body">
								<div>
									<a href="detail_lelang_c2c.jsp" class="f15 bidaktif_Title">Kapal Tanker Pertamina Lokasi Ujung Berung</a>
								</div>
										...
										<div class="table-responsive">
											<table class="table f11">
												<tbody>
													<tr>
														<td class="modif_td">Total bid</td>
														<td class="modif_td">: <a href="bidder_page.jsp">46 Bid</a></td>
													</tr>
													<tr>
														<td class="modif_td">Bid Anda</td>
														<td class="modif_td">: 49.000.000</td>
													</tr>
													<tr>
														<td class="modif_td">Bid Saat ini</td>
										...
										<div class="table-responsive">
											<table class="table f11">
												<tbody>
													...
													<tr>
														<td class="modif_td">Waktu Tersisa</td>
														<td class="modif_td">: 1 hr 2 jam 36 mnt</td>
													</tr>
												</tbody>
											</table>
										</div>
										...
										<div class="table-responsive">
											<table class="table f11">
												<tbody>
													...
													<tr>
														<td class="modif_td">Status Bid</td>
														<td class="modif_td">: Highest Bidder</td>
													</tr>
												</tbody>
											</table>
										</div>
