...
<div id="wrap">
    ...
    <div class="container-fluid container-content ">
			...
			<div class="col-md-10">
				<div class="row">
					<ol class="breadcrumb breadcrumb-style">
						...
						<li><a href="#">Bid saya</a></li>
						<li class="active">Bid yang dimenangkan</li>
					</ol><!-- End Breadcrumb -->
				</div>
			</div>
			<div class="col-md-1"></div>
				...
				<div class="col-md-9" role="main">
					<div class="bs-docs-section bidaktif_SideRight">
						<div class="page-header nomargintop">
							<h4 id="whats" class="title-category">Bid yang anda menangkan</h4>
							<small><cite>" Easiest way to buy, Highest price to sell "</cite></small>
						</div>
						
						<div class="row bidaktif_FormSearch">
							<div class="col-md-4 bidaktif_FormSearchFil">
								<input type="text" class="form-control form-control_custom test-both" id="namaPerusahaan" placeholder="Nama Lelang">
							</div>
							<div class="col-md-3 bidaktif_FormSearchFil">
								<select class="form-control form-control_custom f13">
									...
									<option>Transaksi Dibatalkan</option>
								</select>
							</div>
							<div class="col-md-1 bidaktif_FormSearchFil">
								<button type="button" class="btn btn-default searchres_btn" data-toggle="modal" data-target=".bs-example-modal-sm">Cari</button>
							</div>
						</div>
						...
						<div class="media">
							<div class="media-left">
								<a href="#">
									<img class="media-object" data-src="holder.js/64x64" alt="32x32" src="data:image/svg+xml;base64," data-holder-rendered="true" style="width: 64px; height: 64px;">
								</a>
							</div>
							<div class="media-body">
								<div>
									<a href="../detail_lelang_c2c.jsp" class="bidaktif_Title f15" >Gedung BUMN dengan luas bangunan 1000m2</a>
								</div>
								
								<div class="row">
									<div class="col-md-6">
										<div class="table-responsive">
											<table class="table f11">
												<tbody>
													<tr>
														<td class="modif_td">Total Bid</td>
														<td class="modif_td"><a href="../bidder_page.jsp">: 76 Bid</a></td>
													</tr>
													<tr>
														<td class="modif_td">Bid Terakhir Anda</td>
														<td class="modif_td">: 5.100.000.000</td>
													</tr>
													<tr>
														<td class="modif_td">Jumlah Pembayaran (plus ongkir)</td>
														<td class="modif_td">: 5.100.200.000</td>
													</tr>
													<tr>
														<td class="modif_td">Status Transaksi</td>
														<td class="modif_td">: Belum Bayar</td>
													</tr>
												</tbody>
											</table>
										</div>
									...
									<div class="col-md-6">
										<div class="table-responsive">
											<table class="table f11">
												<tbody>
													<tr>
														<td class="modif_td">Durasi Lelang</td>
														<td class="modif_td">: 17 Juli 2015 - 31 Juli 2015</td>
													</tr>
													<tr>
														<td class="modif_td">Seller</td>
														<td class="modif_td">: karno_sh <a href="#">[Profil Seller]</a></td>
													</tr>
													<tr>
														<td class="modif_td">Lokasi Barang</td>
														<td class="modif_td">:  Jakarta pusat</td>
													</tr>
													<tr>
														<td class="modif_td">Batas Waktu Pembayaran</td>
														<td class="modif_td">: 31 Agustus 2015</td>
													</tr>
												</tbody>
											</table>
										</div>
								...
								<a href="../konfirmasi_pembayaran_c2c.jsp" type="button" class="btn btn-success btn-sm">Konfirmasi Pembayaran</a>
								<a href="../metode_pembayaran_c2c.jsp">Cek Metode Pembayaran?</a> | 
								<a href="#" data-toggle="modal" data-target="#myModal" >History Transaksi</a>
							</div>
						</div>
										...
										<div class="table-responsive">
											<table class="table f11">
												<tbody>
													...
													<tr>
														<td class="modif_td">Status Transaksi</td>
														<td class="modif_td">: Verifikasi Pembayaran</td>
													</tr>
												</tbody>
											</table>
										</div>
										...
										<div class="table-responsive">
											<table class="table f11">
												<tbody>
													...
													<tr>
														<td class="modif_td">Status Transaksi</td>
														<td class="modif_td">: Pembayaran Diterima</td>
													</tr>
												</tbody>
											</table>
										</div>
											...
											<table class="table f11">
												<tbody>
													...
													<tr>
														...
														<td class="modif_td">: 3-4 hari (04 September 2015)</td>
													</tr>
												</tbody>
											</table>
										</div>
										...
										<div class="table-responsive">
											<table class="table f11">
												<tbody>
													...
													<tr>
														<td class="modif_td">Status Transaksi</td>
														<td class="modif_td">: Sedang dalam pengiriman</td>
													</tr>
												</tbody>
											</table>
										</div>
						...
						<div class="media">
							...
							<div class="media-body">
										...
										<div class="table-responsive">
											<table class="table f11">
												<tbody>
													...
													<tr>
														<td class="modif_td">Status Transaksi</td>
														<td class="modif_td">: Transaksi Selesai</td>
													</tr>
												</tbody>
											</table>
										</div>
								...
								<a href="#" type="button" class="btn btn-success btn-sm">Beri Feedback</a>
								<a href="#" data-toggle="modal" data-target="#myModal" >History Transaksi</a>
							</div>
						</div>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<table class="table table-hover">
											...
											<tbody>
												<tr>
													<th scope="row">29 Juli 2015 16:25</th>
													<td><code>Bidder</code></td>
													<td>Menang Lelang</td>
													<td>Bidder memenangkan lelang yang diikuti</td>
												</tr>
												<tr>
													<th scope="row">30 Juli 2015 15:20</th>
													<td><code>Bidder</code></td>
													<td>Konfirmasi Pembayaran</td>
													<td>Bidder melakukan konfirmasi pembayaran</td>
												</tr>
												<tr>
													<th scope="row">30 Juli 2015 16:20</th>
													<td><code>System</code></td>
													<td>Verifikasi Pembayaran</td>
													<td>Sistem memverifikasi pembayaran bidder dan mengirim info ke seller</td>
												</tr>
												<tr>
													<th scope="row">31 Juli 2015 12:20</th>
													<td><code>Seller</code></td>
													<td>Approve Pembayaran</td>
													<td>Seller melakukan approve pembayaran sebagai trigger akan mengirim barang</td>
												</tr>
												<tr>
													<th scope="row">31 Juli 2015 10:20</th>
													<td><code>Seller</code></td>
													<td>Konfirmasi Pengiriman</td>
													<td>Seller konfirmasi pengiriman barang</td>
												</tr>
												<tr>
													<th scope="row">04 Agustus 2015 10:20</th>
													<td><code>Bidder</code></td>
													<td>Barang Sudah Diterima</td>
													<td>Bidder konfirmasi barang sudah diterima</td>
												</tr>
												<tr>
													<th scope="row">04 Agustus 2015 10:20</th>
													<td><code>System</code></td>
													<td>Transfer Pembayaran</td>
													<td>Sistem mengirim pembayaran ke seller</td>
												</tr>
												<tr>
													<th scope="row">05 Agustus 2015 10:20</th>
													<td><code>Seller</code></td>
													<td>Penerimaan Pembayaran</td>
													<td>Seller melakukan approve pembayaran</td>
												</tr>
											</tbody>
										</table>
									</div>
						...
						<!-- End of Modal History Transaksi -->
		...
		<div class="row inner_pagi">
			...
			<div class="col-md-10">
				<div class="col-md-5 inner_pagi_top">
					<small class="pull-left">Daftar Produk&nbsp;<b>1 - 30</b>&nbsp;dari&nbsp;<b>340.226</b></small>
				</div>
				<div class="col-md-7">
				<ul class="pagination pagination-sm pull-right inner_pagi_top">
					<li><a href="#" aria-label="Previous"><span aria-hidden="true">Sebelumnya</span></a></li>
					<li><a href="#">1</a></li>
					<li><a href="#">2</a></li>
					<li><a href="#">3</a></li>
					<li><a href="#">4</a></li>
					<li><a href="#">5</a></li>
					<li><a href="#" aria-label="Next"><span aria-hidden="true">Selanjutnya</span></a></li>
				</ul>
				</div>
			</div>
		</div>
    ...
    jQuery(document).ready(function () {
        $("#input-21f").rating({
            ...
            starCaptionClasses: function(val) {
                if (val < 3) {
                    return 'label_header label-danger';
                } else {
                    return 'label_header label-success';
                }
            },
            hoverOnClear: false
        });
