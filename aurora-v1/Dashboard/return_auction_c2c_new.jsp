...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Pengembalian Lelang</title>
			...
			<div class="col-md-10">
				<div class="row">
					<ol class="breadcrumb breadcrumb-style">
						...
						<li class="active">Pengembalian Lelang</li>
					</ol><!-- End Breadcrumb -->
				</div>
			</div>
			<div class="col-md-1"></div>
				...
				<div class="col-md-9" role="main">
					<div class="bs-docs-section bidaktif_SideRight">
						<div class="page-header nomargintop">
							<h4 id="whats" class="title-category">Pengembalian Lelang</h4>
									...
									<div class="col-md-6">
										<div class="table-responsive">
											<table class="table f11">
												<tbody>
													<tr>
														<td class="modif_td">Bidder Pemenang</td>
														<td class="modif_td">denas176 <a href="#">[Kontak Bidder]</a></td>
													</tr>
													<tr>
													...
													<tr>
														<td class="modif_td">Harga Terakhir</td>
														<td class="modif_td">: 5.100.500.000</td>
													</tr>
												</tbody>
											</table>
										</div>
									...
									<div class="col-md-6">
										<div class="table-responsive">
											<table class="table f11">
												<tbody>
													<tr>
														<td class="modif_td">Tanggal Pengembalian</td>
														<td class="modif_td">: 17 Juli 2015</td>
													</tr>
													<tr>
														<td class="modif_td">Alasan Pengembalian</td>
														<td class="modif_td">:  Barang tidak sesuai dengan aktualnya. Terdapat komponen barang yang di kanibal.</td>
													</tr>
												</tbody>
											</table>
										</div>
