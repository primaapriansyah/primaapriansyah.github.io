				...
				<ul class="nav navbar-nav nav-tab ">
					...
					<li class="dropdown messages-menu list-notif">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span class="label_header label-success">1</span>
						</a>
					...
					<li class="dropdown notifications-menu list-notif">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span class="label_header label-warning">10</span>
						</a>
						<ul class="dropdown-menu margindropdown">
									...
									<table class="table table-font">
										<tbody><tr>
											<td>
												...
												<a href="#">Bid Aktif <span class="badge badgesCustom">1</span></a>
											</td>
										</tr>
										<tr>
											<td>
				...
				<div class="col-md-9">
					<div class="row" style="margin-left:20px !important;">
						<div class="page-header text-center headerCustom">
							<h4 class="title-category">Win Bid</h4>
						</div>
						...
						<div class="table-responsive tablefont">
							...
							<thead>
								<tr>
									...
									<th class="text-center vertable">Bid Terakhir Anda</th>
									<th class="text-center vertable">Status Pembayaran</th>
								</tr>
							</thead>
							<tbody>
								<tr data-toggle="collapse" data-target="#demo1" class="accordion-toggle">
									...
									<td><code>Belum Bayar</code></td>
								</tr>
								<tr>
									<td colspan="8" class="hiddenRow">
										<div class="accordian-body collapse in Hidden_accorbid" id="demo1">
											<div>
												...
												<div class="media-body">
													...
													<table class="table table-user-information" style="font-size: 11px;">
														<tbody>
															...
															<tr>
																<td>Jumlah Pembayaran + ongkos kirim</td>
																<td>Rp 5.100.200.000</td>
															</tr>
															<tr>
																<td>Batas Waktu Pembayaran</td>
																<td>31 Agustus 2015</td>
															</tr>
															<tr>
																<td>Total Bid</td>
																<td><a href="#">76 Bid</a></td>
															</tr>
															<tr>
																<td>Nama Seller</td>
																<td>karno_sh <a href="#">[Profil Seller]</a></td>
															</tr>
															<tr>
																<td>Lokasi</td>
											...
											<div class="row">
												<strong class="text-danger">Feedback</strong>
												<div class="star-rating rating-xs rating-active">
													<div class="rating-container rating-gly-star">
														<div class="form-group form-style">
															<div class="row">
																<div class="col-md-4">
																	<label for="exampleInputEmail1" class="label-form">Akurasi</label>
																<input id="input-21e" value="0" type="number" class="rating form-control hide" min="0" max="5" step="0.5" data-size="xs">
																</div>
																
																<div class="col-md-4">
																	<label for="exampleInputEmail1" class="label-form">Kualitas</label>
																	<input id="input-21e" value="0" type="number" class="rating form-control hide" min="0" max="5" step="0.5" data-size="xs">
																</div>
																
																<div class="col-md-4">
																	<label for="exampleInputEmail1" class="label-form">Kecepatan</label>
																	<input id="input-21e" value="0" type="number" class="rating form-control hide" min="0" max="5" step="0.5" data-size="xs">
																</div>
															</div>	
														</div>
