...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Edit Interest Auction</title>
				...
				<div class="col-md-9" role="main">
					<div class="bs-docs-section bidaktif_SideRight">
						<div class="page-header nomargintop">
							<h4 id="whats" class="title-category">Ubah Ketertarikan Lelang</h4>
							<small><cite>" Easiest way to buy, Highest price to sell "</cite></small>
						</div>
						<div class="row content-profile akunsaya_pp">
							<form class="form-horizontal">
								<label class="checkbox-inline">
									<input type="checkbox" id="mesin" value="option1">Barang Antik &amp; Seni
								</label>
								<label class="checkbox-inline">
									<input type="checkbox" id="elektronik" value="option2">Elektronik
								</label>
								<label class="checkbox-inline">
									<input type="checkbox" id="rumahtanah" value="option3">Fashion
								</label><br><br>
								<label class="checkbox-inline">
									<input type="checkbox" id="mobilmotor" value="option1">Transportasi
								</label>
								<label class="checkbox-inline">
									<input type="checkbox" id="scrapbesi" value="option2">Properti
								</label>
								<label class="checkbox-inline">
									<input type="checkbox" id="scrapbesi" value="option2">Hobi &amp; Olahraga
								</label>
								<label class="checkbox-inline">
									<input type="checkbox" id="scrapbesi" value="option2">Lelang Proyek
								</label>
								<label class="checkbox-inline">
									<input type="checkbox" id="scrapplastik" value="option3">Lelang Lainnya
								</label><br><br>
								<div class="alert alert-warning">
									Ketertarikan lelang yang sudah anda ikuti : Elektronik, Properti, Fashion
								</div>
								
								<div class="form-group">
									<div class="col-sm-12">
										<a href="#" type="button" class="btn btn-primary btn-sm" style="float: right !important;" data-toggle="modal" data-target="#myModal">+ Tambah Interest Auction</a>
									</div>
								</div>
							...
							<!-- Modal Add Interest Auction -->
							<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
								<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
										<h4 class="modal-title" id="myModalLabel">Tambah Interest Auction</h4>
									</div>
							...
							<!-- End of Modal Add Interest Auction -->
						</div>
					</div>	
				</div> 
				<!-- End SideRight Content-->
			</div>	
			<div class="col-md-1"></div>
		</div> 
		<!-- End Row -->
