				...
				<div class="col-md-9">
					<div class="row" style="margin-left:20px !important;">
						<div class="page-header text-center headerCustom">
							<h4 class="title-category">All Bid</h4>
						</div>
						...
						<div class="row" style="margin-bottom:30px;margin-left:-3px;">
							...
							<div class="col-md-3" style="padding-right:0;padding-left: 3px;">
								<select class="form-control form-control_custom" style="font-size:13px;">
									...
									<option>Menang Lelang</option>
									<option>Tidak Menang Lelang</option>
								</select>
							</div>
							<div class="col-md-3" style="padding-right:0;padding-left: 3px;">
								<select class="form-control form-control_custom" style="font-size:13px;">
							...
							<table class="table table-bordered" style="border-collapse:collapse;">
								<thead>
									<tr>
										...
										<th class="text-center vertable">Bid Anda</th>
										<th class="text-center vertable">Bid Terakhir</th>
										<th class="text-center vertable">Status Bid</th>
									</tr>
								</thead>
								<tbody>
									<tr data-toggle="collapse" data-target="#demo2" class="accordion-toggle">
										<td><input type="checkbox"></td>
										<td><a href="#">Kapal Tanker Pertamina Kap. 6000 Ton</a></td>
										<td>27 Juli 2015 - 11 Agustus 2015</td>
										<td>Rp 4.900.000.000</td>
										<td>Rp 5.100.000.000</td>
										<td><code>Outbid</code></td>
									</tr>
									<tr>
										<td colspan="6" class="hiddenRow">
											<div id="demo2" class="accordian-body collapse Hidden_accorbid">
													...
													<strong class="text-danger">Kapal Tanker Pertamina Lokasi Ujung Berung</strong>
														<div class="table-responsive">
															<table class="table" style="font-size: 11px;">
																...
																<tbody>
																	...
																	<tr>
																	  <td>Total Bid</td>
																	  <td>: <a href="../bidder_page.jsp">44</a></td>
																	</tr>
																	<tr>
																	  <td>Waktu Tersisa</td>
																	  <td>: 02 Hari : 09 Jam : 18 Menit : 23 Detik [31 Agustus 2015 08.30 WIB]</td>
																	</tr>
																	<tr>
																	  <td>Seller</td>
														...
														<form class="form-inline" style="margin-bottom:20px;">
															<div class="form-group">
																<label class="sr-only" for="exampleInputAmount">Jumlah</label>
																<div class="input-group">
									...
									<tr data-toggle="collapse" data-target="#demo3" class="accordion-toggle">
										<td><input type="checkbox"></td>
										<td><a href="#">Nikon D3300 DSLR 24.2 MP HD 1080p Camera</a></td>
										<td>27 Juli 2015 - 11 Agustus 2015</td>
										<td>Rp 7.100.000.000</td>
										<td>Rp 5.100.000.000</td>
										<td><code>Lead Bid</code></td>
									</tr>
									<tr>
										<td colspan="6" class="hiddenRow">
											<div id="demo3" class="accordian-body collapse Hidden_accorbid">
													<div class="media-left">
														<a href="#">
															<img class="media-object" data-src="holder.js/64x64" alt="64x64" src="data:image/svg+xml;base64," data-holder-rendered="true" style="width: 150px; height: 150px;">
														</a>
