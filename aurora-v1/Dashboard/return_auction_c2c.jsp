				...
				<div class="col-md-9">
					<div class="row">
						<div class="page-header text-center headerCustom">
							<h4 class="title-category">Pengembalian Lelang!</h4>
						</div>
						...
						<div class="table-responsive tablefont">
							...
							<thead>
								<tr>
									...
									<th class="text-center vertable">Harga Terakhir</th>
									<th class="text-center vertable">Bidder Pemenang</th>
								</tr>
							</thead>
							<tbody>
												...
												<div class="media-body">
													...
													<table class="table table-user-information" style="font-size: 11px;">
														<tbody>
															...
															<tr>
																<td>Bidder Pemenang</td>
																<td>denas176 <a href="#">[Kontak Bidder]</a></td>
															</tr>
															<tr>
															...
															<tr>
																...
																<td>Barang tidak sesuai dengan aktualnya. Terdapat komponen barang yang di kanibal.</td>
															</tr>
														</tbody>
													</table>
