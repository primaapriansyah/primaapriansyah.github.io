				...
				<div class="col-md-9">
					<div class="row">
						<div class="page-header text-center headerCustom">
							<h4 class="title-category">Daftar Lelang yang sudah terjual!</h4>
						</div>
						...
						<div class="table-responsive tablefont">
							...
							<tbody>
								<tr data-toggle="collapse" data-target="#demo1" class="accordion-toggle">
									...
									<td><a href="../bidder_page.jsp">46 Bid</a></td>
								</tr>
								<tr>
								...
								<div class="modal-body">
									<form>
										<div class="form-group">
											<label for="recipient-name" class="control-label">No. Pengiriman:</label>
