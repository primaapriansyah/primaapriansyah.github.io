				...
				<div class="col-md-9" role="main">
					<div class="bs-docs-section bidaktif_SideRight">
						<div class="page-header nomargintop">
							<h4 id="whats" class="title-category">Ubah Rekening</h4>
							<small><cite>" Easiest way to buy, Highest price to sell "</cite></small>
						</div>
						<div class="row content-profile akunsaya_pp">
							<form class="form-horizontal">
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label control-label-custom">Nama Pengguna Rekening</label>
									<div class="col-sm-8">
										<input type="email" class="form-control" id="NamaPengguna" placeholder="Dena Sucianandika">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="email" class="form-control" id="NamaBank" placeholder="Bank BCA">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="email" class="form-control" id="NomorRekening" placeholder="8850676223">
									</div>
								</div>
