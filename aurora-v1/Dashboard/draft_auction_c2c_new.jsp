			...
			<div class="col-md-10">
				<div class="row">
					<ol class="breadcrumb breadcrumb-style">
						...
						<li class="active">Draft Lelang</li>
					</ol><!-- End Breadcrumb -->
				</div>
			</div>
			<div class="col-md-1"></div>
				...
				<div class="col-md-9" role="main">
					<div class="bs-docs-section bidaktif_SideRight">
						<div class="page-header nomargintop">
							<h4 id="whats" class="title-category">Draft Lelang</h4>
						...
						<div class="media">
							...
							<div class="media-body">
								<div>
									<a href="#" class="bidaktif_Title f15">Gedung BUMN dengan luas bangunan 1000m2</a>
								</div>
									...
									<div class="col-md-6">
										<div class="table-responsive">
											<table class="table f11">
												<tbody>
													<tr>
														<td class="modif_td">Kategori</td>
														<td class="modif_td">Properti</td>
													</tr>
													<tr>
													...
													<tr>
														<td class="modif_td">Kondisi</td>
														<td class="modif_td">: Bekas</td>
													</tr>
												</tbody>
											</table>
										</div>
								...
								<a href="../detail_lelang_c2c.jsp" type="button" class="btn btn-success btn-sm">Review Lelang</a>
								<a href="#" type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target=".bs-example-modal-sm">Publish Lelang</a>
								
								
								<!-- Modal Publish Auction -->
								<div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
									<div class="modal-dialog modal-sm">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">x</span></button>
												<h4 class="modal-title" id="mySmallModalLabel">Konfirmasi Publish Lelang</h4>
											</div>
											<div class="modal-body">
												<p>Anda yakin untuk mempublish lelang ini tanpa mereviewnya lagi?</p>
											</div>
											<div class="modal-footer">
												<a href="../detail_lelang_c2c.jsp" type="button" class="btn btn-default btn-success">Review Lelang</a>
												<a type="button" class="btn btn-primary">Publish</a>
											</div>
										</div>
									</div>
								</div>
								<!-- End of Modal Publish Auction -->
