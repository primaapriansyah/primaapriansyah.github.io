						...
						<div class="row" style="margin-bottom:30px;margin-left:-3px;">
							...
							<div class="col-md-3" style="padding-right:0;padding-left: 3px;">
								<select class="form-control form-control_custom" style="font-size:13px;">
									<option>Status Lelang</option>
									<option>Pre Auction</option>
									<option>Live Auction</option>
									<option>Closed Auction</option>
								</select>
							</div>
						...
						<div class="table-responsive tablefont">
							...
							<thead>
								<tr>
									...
									<th class="text-center vertable">Total Bid</th>
									<th class="text-center vertable">Total Bidder</th>
									<th class="text-center vertable">Bid Terakhir</th>
									<th class="text-center vertable">Waktu Tersisa</th>
									<th class="text-center vertable">Status Lelang</th>
								</tr>
							</thead>
							<tbody>
								<tr data-toggle="collapse" data-target="#demo1" class="accordion-toggle">
									...
									<td><a href="../bidder_page.jsp">46</a></td>
									<td><a href="../bidder_page.jsp">22</a></td>
									<td>Rp 100.000.000</td>
									<td>-</td>
									<td><code>Closed Auction</code></td>
								</tr>
								<tr>
												...
												<div class="media-body">
													...
													<table class="table table-user-information" style="font-size: 11px;">
														<tbody>
														  ...
														  <tr>
															<td>Total Bidder</td>
															<td><a href="#">34 Bidder</a></td>
														  </tr>
														  <tr>
															<td>Nama Seller</td>
															<td>
																<code>PT Pertamina Persero</code>
															</td>
														  </tr>
														</tbody>
													</table>
													<a href="#" type="button" class="btn btn-info btn-sm">Lihat Selengkapnya</a>
													<a href="#" type="button" class="btn btn-success btn-sm">Add to Watchlist</a>
													<a href="#" type="button" class="btn btn-success btn-sm">Follow Seller</a>
												</div>
											</div>
										</div> 
									</td>
