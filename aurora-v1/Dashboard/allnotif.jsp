    ...
    <div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-10">
				...
				<!-- SideRight Content -->
				<div class="col-md-9">
					<div class="page-header text-center headerCustom" style="margin-left:20px;">
						<h4 class="title-category">Semua Pemberitahuan</h4>
					</div>
					
					<div class="row" style="margin-left:20px;">
						<div class="panel panel-default" style="border-radius:0 !important;">
							<!-- Default panel contents -->
							<div class="panel-heading" style="color:#565a5c; font-size:16px; padding-top:12px; padding-bottom:12px;">Pemberitahuan Anda <a href="#" type="button" class="btn-group btn-group-sm" style="float:right;font-size:11px">Setting Pemberitahuan</a></div>
							<!-- List group -->
							<ul class="list-group">
								<li class="list-group-item">
									<div class="media">
										<div class="media-left">
											<a href="#">
											  <img class="media-object" data-src="holder.js/64x64" alt="64x64" src="data:image/svg+xml;base64," data-holder-rendered="true" style="width: 35px; height: 35px;">
											</a>
										</div>
										<div class="media-body">
											<a href="#"><p class="media-heading" style="font-size:13px !important;">Private bidder telah memasukkan Bid ke <code>Lelang mobil Avanza thn 2012</code> sebesar <code>Rp 180.000.000</code></p></a>
											<div class="btn-group btn-group-sm" style="font-size:11px">
												<a href="#">Baca</a> |
												<a href="#">Hapus</a>
											</div>
										</div>
								...
								<li class="list-group-item" style="background-color:rgba(245, 245, 245, 0.47);">
									<div class="media">
										<div class="media-left">
											<a href="#">
											  <img class="media-object" data-src="holder.js/64x64" alt="64x64" src="data:image/svg+xml;base64," data-holder-rendered="true" style="width: 35px; height: 35px;">
