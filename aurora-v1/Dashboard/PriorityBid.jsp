...
<body>
    ...
    <div class="container-fluid">
		...
		<div class="col-sm-10 col-md-10">
			<div class="row">
				<h3 class="hot-auction-label"><span>Priority Bid</span></h3>
				<div class="col-md-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Priority Bid</h3>
                </div><!-- /.box-header -->
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
					  ...
					  <td><a href="#"><button type="button" class="btn btn-primary btn-sm" style="width:100%;">Bid</button></a></td>
                    </tr>
					<tr>
                      <td><a href="detail_tomjer.html">132671</a></td>
                      <td>Kapal Tanker Pertamina</td>
