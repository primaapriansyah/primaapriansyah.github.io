			...
			<div class="col-md-10">
				<div class="row">
					<ol class="breadcrumb breadcrumb-style">
						...
						<li class="active">Edit Informasi Profil</li>
					</ol><!-- End Breadcrumb -->
				</div>
			</div>
			<div class="col-md-1"></div>
				...
				<div class="col-md-9" role="main">
					<div class="bs-docs-section bidaktif_SideRight">
						<div class="page-header nomargintop">
							<h4 id="whats" class="title-category">Ubah Informasi Profil Saya</h4>
						...
						<div class="row content-profile akunsaya_pp">
							<form class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-8">
									  <input type="email" class="form-control" id="FullName" placeholder="Dena Sucianandika" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
									  <input type="email" class="form-control" id="Username" placeholder="dena.sucianandika@gmail.com" readonly>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<label class="checkbox-inline">
											<input type="checkbox" id="Male" value="option1">Pria
										</label>
										<label class="checkbox-inline">
											<input type="checkbox" id="Female" value="option1">Wanita
										</label>
									</div>
								</div>
								...
								<div class="form-actions well">
									<a href="MyProfile_c2c_new.jsp" class="btn btn-primary save">Save</a>
									<a href="MyProfile_c2c_new.jsp" class="btn btn-default">Cancel</a>
								</div>
							</form>
								  ...
								  <div class="modal-body">
									<form class="form-horizontal">
									  <div class="form-group">
										<label for="inputEmail3" class="col-sm-3 control-label control-label-custom">Username</label>
										<div class="col-sm-8">
										  <input type="email" class="form-control" id="UsernameCPass" placeholder="dena.sucianandika@gmail.com" readonly>
										</div>
									  </div>
									  <div class="form-group">
										<label for="inputEmail3" class="col-sm-3 control-label control-label-custom">Password Lama</label>
										<div class="col-sm-8">
										  <input type="password" class="form-control" id="OldPass" placeholder="Password Lama">
										</div>
									  </div>
									  <div class="form-group">
									  ...
									  <div class="form-group">
										...
										<div class="col-sm-8">
										  <input type="password" class="form-control" id="ConfNewPass" placeholder="Konfirmasi Password Baru">
										</div>
									  </div>
									</form>
								  </div>
