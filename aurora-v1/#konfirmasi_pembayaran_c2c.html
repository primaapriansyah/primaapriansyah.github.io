...
<div id="wrap">
	...
	<div class="container-fluid container-content">
		...
		<div class="row">
			...
			<div class="col-md-10">
				<div class="page-header text-center">
					<h3 class="title-category">Konfirmasi Pembayaran</h3>
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-10">
				<div class="col-md-8">
					<p class="title-category"><i>Note : Pastikan Anda mengisi form konfirmasi pembayaran dengan tepat!</i></p><br>
					<form role="form" action="" method="post">
						<div class="form-group fullreg_formgroup">
							<label for="namaPerusahaan" class="label_style">Invoice</label>
							<input type="text" class="form-control form-control_custom test-both" id="nomor_invoice" placeholder="INV/20150729/IX/VI/332456" readonly>
						</div>
						<div class="form-group fullreg_formgroup">
							<label for="namaPerusahaan" class="label_style">Tanggal Pembayaran</label>
								<div class="row">
									<div class="col-md-2 confirm_payment_date">
										<select class="form-control">
											<option>01</option>
										</select>
									</div>
									<div class="col-md-4 confirm_payment_date">
										<select class="form-control">
											<option>Juli</option>
										</select>
									</div>
						...
						<div class="form-group fullreg_formgroup">
							<div class="form-group fullreg_formgroup">
								<label for="namaPerusahaan" class="label_style">Nama Pemilik Rekening</label>
								<input type="text" class="form-control form-control_custom test-both" id="NamaPemilikRek" placeholder="">
							</div>
							
							<div class="form-group fullreg_formgroup">
								<label for="namaPerusahaan" class="label_style">Nama Bank Pengirim</label>
								<input type="text" class="form-control form-control_custom test-both" id="NamaBank" placeholder="">
							</div>
						</div>
						
						<hr><br>
						<div class="form-group fullreg_formgroup">
							<label for="namaPerusahaan" class="label_style">Rekening Tujuan</label>
							<select class="form-control">
								<option>Pilih Rekening Tujuan</option>
								<option>Bank BCA 332323 a/n: AuctionParty</option>
								<option>Bank Mandiri 332323 a/n: AuctionParty</option>
								<option>Bank BNI 332323 a/n: AuctionParty</option>
								<option>Bank BRI 332323 a/n: AuctionParty</option>
							</select>
						</div>
						<div class="form-group fullreg_formgroup">
							<label for="namaPerusahaan" class="label_style">Jumlah yang dibayar</label>
							<input type="text" class="form-control form-control_custom test-both" id="namaPerusahaan">
						</div>
						<div class="form-group fullreg_formgroup">
							<label for="namaPerusahaan" class="label_style">Keterangan</label>
							<textarea class="form-control form-control_custom" placeholder="Keterangan Pembayaran" rows="3"></textarea>
						</div>
				...
				<div class="col-md-4">
					<div class="row">
						<div class="bg_style">
							<p><strong class="text-danger">Ringkasan Lelang</strong></p>
							<table class="table table-user-information" style="font-size: 11px;">
								<tbody>
									<tr>
										<td class="col-md-4">Nama Lelang</td>
										<td>Gedung BUMN dengan luas bangunan 1000m2</td>
									</tr>
									<tr>
										<td>Durasi</td>
										<td>17 Juli 2015 - 26 Juli 2015</td>
									</tr>
									<tr>
										<td>Lokasi</td>
										<td>Jln Kalimantan No 12 MM2100 Cikarang Barang</td>
									</tr>
									<tr>
							...
							<p><strong class="text-danger">Tahapan Pelelangan Anda :</strong></p>
							<ol>
								<li>Pilih Lelang</li>
								<li>Masukan Bid</li>
								<li>Konfirmasi Pembayaran</li>
								<li class="title-category"><i>Terima Barang</i></li>
								<li class="title-category"><i>Konfirmasi Penerimaan Barang</i></li>
								<li class="title-category"><i>Selesai</i></li>
							</ol>
						</div><br>	
					</div>
				</div>
		...
		<div class="modal fade" id="AddRekeningKonfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					...
					<div class="modal-body">
						<form class="form-horizontal">
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label control-label-custom">Nama Bank yang digunakan</label>
								<div class="col-sm-8">
								  <input type="text" class="form-control" id="add_nama_bank" placeholder="Nama Bank yang digunakan">
								</div>
							</div>
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label control-label-custom">Nomor Rekening</label>
								<div class="col-sm-8">
								  <input type="text" class="form-control" id="add_nomor_rekening" placeholder="Nomor Rekening">
								</div>
							</div>
						</form>
					</div>
