				...
				<div class="row style_loginreg">
					<div class="col-md-8">
						<form class="login_page">
							<h4 class="fontgreen">Bagaimana pendapat anda tentang Waterbe?</h4>
							<hr>
							<table class="table table-user-information f11">
								<tbody>
									<tr>
										<td>Loading Website</td>
										<td><input id="input-21e" value="0" type="number" class="rating" min=0 max=5 step=0.5 data-size="xs" ></td>
									</tr>
									<tr>
							...
							<small class="fontgreen">Anda dapat memberikan testimoni, saran, ide ataupun kritikan pada kami agar dapat lebih memenuhi kebutuhan anda</small>
							<div class="form-group form-style feedback_textarea">
								<textarea class="form-control input-sm" id="DeskripsiBarang" rows="6" placeholder="Kami dengan senang hati menerima masukan dari anda!"></textarea>
							</div>
							<button type="submit" class="btn btn-primary btn">Kirim</button>
						</form>
					</div>
					<div class="col-md-3 reg_loginpage feedback_ctus">
						<div class="media-body feedback_ctusbody">
							<h3 class="text-center fontgreen">Hubungi Kami</h3>
							<ul class="nav text-center">
								<li><a href="#"><i class="fa fa-map-marker" class="contactus_map"></i> Lokasi Kami :<p class="contactus_desc">Jalan Jend Sudirman Gd. Sampoerna Lt. 15. Jakarta Selatan</p></a></li>
