			...
			<div class="col-md-10">
				<div class="row">
					<ol class="breadcrumb breadcrumb-style">
						...
						<li class="active">Ruko dengan Luas Bangunan 200 M2, Lokasi Strategis daerah Kelapa Gading</li>
					</ol>
				</div>
			</div>
			<div class="col-md-1"></div>
	...
	<div class="row">
		...
		<div class="col-md-10">
			<div class="row">
				<div class="col-md-5">
					<div class="demo">
						<ul id="imageGallery" class="gallery list-unstyled">
							<li data-thumb="img/building/gedungpre3.jpg" data-src="img/building/gedungpre3.jpg"> <img class="slidercustom" src="img/building/gedungpre3.jpg" /></li>
							<li data-thumb="img/building/gedung1.jpeg" data-src="img/building/gedung1.jpeg"><img class="slidercustom" src="img/building/gedung1.jpeg" /></li>
							<li data-thumb="img/building/gedung2.jpg" data-src="img/building/gedung2.jpg"> <img class="slidercustom" src="img/building/gedung2.jpg" /></li>
							<li data-thumb="img/building/gedung3.jpg" data-src="img/building/gedung3.jpg"><img class="slidercustom" src="img/building/gedung3.jpg" /></li>
							<li data-thumb="img/building/gedung4.jpg" data-src="img/building/gedung4.jpg"> <img class="slidercustom" src="img/building/gedung4.jpg" /></li>
							<li data-thumb="img/building/gedungclosed1.jpg" data-src="img/building/gedungclosed1.jpg"><img class="slidercustom" src="img/building/gedungclosed1.jpg" /></li>
							<li data-thumb="img/building/gedungclosed2.jpg" data-src="img/building/gedungclosed2.jpg"> <img class="slidercustom" src="img/building/gedungclosed2.jpg" /></li>
							<li data-thumb="img/building/gedungext.jpg" data-src="img/building/gedungext.jpg"><img class="slidercustom" src="img/building/gedungext.jpg" /></li>
							<li data-thumb="img/building/gedungext2.jpg" data-src="img/building/gedungext2.jpg"> <img class="slidercustom" src="img/building/gedungext2.jpg" /></li>
							<li data-thumb="img/building/gedungclosed2.jpg" data-src="img/building/gedungclosed2.jpg"> <img class="slidercustom" src="img/building/gedungclosed2.jpg" /></li>
							<li data-thumb="img/building/gedungext.jpg" data-src="img/building/gedungext.jpg"><img class="slidercustom" src="img/building/gedungext.jpg" /></li>
							<li data-thumb="img/building/gedungext2.jpg" data-src="img/building/gedungext2.jpg"> <img class="slidercustom" src="img/building/gedungext2.jpg" /></li>
						</ul>	
				...
				<div class="col-md-7">
					<div class="row ">
						<div class="col-md-12 detail-auction">
							<h4 class="bs-callout bs-callout-warning bs-callout-custom">Ruko dengan Luas Bangunan 200 M2, Lokasi Strategis daerah Kelapa Gading</h4>
							<table class="table table-user-information">
								<tbody>
									<tr>
										<td>Waktu Tersisa</td>
										<td>9 hari 12 jam [07 September 17:00]</td>
									</tr>
									<tr>
										<td>Kondisi</td>
										<td>Bekas</td>
									...
									<tr>
										<td>Lokasi</td>
										<td>Jln Sukarno No. 14 Jakarta Utara</td>
									</tr>
									<tr>
										<td>Jumlah Bid</td>
										<td><a href="bidder_page.jsp">18 Bid</a></td>
									</tr>
									<tr>
										<td>Donasi</td>
										<td>10% <a href="#">[Palang Merah Indonesia]</a></td>
									</tr>
									<tr>
										<td>Harga Pembuka</td>
									...
									<tr>
										...
										<td>
											<form class="form-inline">
												...
												<button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Bid</button>
											</form>
											<small><i>Masukkan angka diatas Rp 2.020.000.000,- atau lebih</i></small>
										</td>
									</tr>
								</tbody>
							</table>
			...
			<!-- Detail Auction Modal Confirmation -->
			<div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
				<div class="modal-dialog modal-sm">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							<h4 class="modal-title" id="myModalLabel">Konfirmasi Bid</h4>
						</div>
						<div class="media">
							<div class="media-body">
								<strong class="text-danger">Ruko dengan Luas Bangunan 200 M2, Lokasi Strategis daerah Kelapa Gading</strong>
								<div class="table-responsive detailauc_mdl_tbl">
									<table class="table f12">
										...
										<tbody>
											...
											<tr>
												<td>Bid Anda</td>
												<td>: Rp 2.120.000.000</td>
											</tr>
										</tbody>
									</table>
								</div>
								<p class="f11"><i>Note : Dengan Anda mengklik Konfirm anda berkomitmen dalam mengikuti pelelangan ini.</i> </p>
							</div>
						</div>
						
						<div class="modal-footer">
							<a href="login_page_afterBid.jsp" type="button" class="btn btn-success btn-sm">Konfirmasi Bid</a>
						</div>
					
					</div>
				</div>
			</div>
			<!-- End Detail Auction Modal Confirmation -->
			<br>
			
			
			<!-- Detail Auction Seller and Elapsed Time -->
			<div class="row">
				<div class="col-md-7">
					<div class="box box-white box-shadow p-10">
						<h5>Informasi Seller</h5><hr>
						<h5><b>Dena SA</b></h5>
						<p>Perum Bumi sani permai blok e1 no 14</p><hr>
						<a href="#">Lihat selengkapnya</a>
					</div>
				</div>
				<div class="col-md-5">
					<div class="box box-white box-shadow p-10">
						<h5>Elapsed Time</h5><hr>
						<ul class="countdown">
							<li>
			...
			<!-- End of Detail Auction Seller and Elapsed Time -->
			
			
			<!-- Detail Auction Tabs Description -->
			<div class="row">
				<div class="col-md-12">
					<div class="box box-white box-shadow p-10">
					<ul id="myTabs" class="nav nav-tabs tabs-style" role="tablist">
						<li role="presentation" class="active">
							<a href="#home" id="home-tab" style="font-size: 14px !important;" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">Deskripsi Item</a>
						</li>
						<li role="presentation" class="">
							<a href="#profile" role="tab" id="profile-tab" style="font-size: 14px !important;" data-toggle="tab" aria-controls="profile" aria-expanded="false">Pengiriman dan Pembayaran</a>
						</li>
					</ul>
					
					<div id="myTabContent" class="tab-content detailauc_tab">
						...
						<div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
							<h5 class="ship_pay_tab">Pengiriman</h5>
							<div class="table-responsive">
								<table class="table col-md-4 f12">
									<colgroup>
										<col class="col-md-2">
										<col class="col-md-7">
									</colgroup>
									<tbody>
										<tr>
											<td class="modif_td">Metode Pengiriman</td>
											<td class="modif_td">: JNE - Paket Regular | COD [<a href="#">kontak seller</a>]</td>
										</tr>
										<tr>
											<td class="modif_td">Ongkos Kirim</td>
											<td class="modif_td">: Rp 9.000 (JNE - Paket Regular)</td>
										</tr>
										<tr>
											<td class="modif_td">Estimasi Pengiriman</td>
											<td class="modif_td">: 3 hari</td>
										</tr>
									</tbody>
								</table>
							</div>
							
							<h5 class="ship_pay_tab">Metode Pembayaran</h5>
							<div class="row">
								<div class="col-md-7">
									<p>Metode pembayaran waterbe mengunakan fasilitas Escrow atau rekening bersama.
									Sehingga akan menjamin 100% keamanan dari transaksi yang dilakukan. Bidder tidak perlu takut akan kehilangan uang
									dan seller pun tidak perlu takut untuk tidak dibayar. </p>
								</div>
								<div class="col-md-5">
									<div id="product-detailed-essential__benefit-and-trust-info">
										<div>
											<span class="safe-guarantee">
												<a href="/aman" target="_blank">Jaminan 100% Aman</a>
											</span>
										</div>
										<ul>
											<li>Uang pasti kembali</li>
											<li>Payment system bebas penipuan</li>
										</ul>
									</div>
								</div>
							</div>
							
							<h5 class="ship_pay_tab">Pilihan Bank yang digunakan untuk Rekening Bersama</h5>
							<div class="row">
								<div class="bs-glyphicons">
									<ul class="bs-glyphicons-list">
										<li>
											<img src="img/logo_bca.png" alt="HTML5 Icon" style="width:50px; height:30px;">
											<span class="glyphicon-class">Bank BCA</span>
											<p class="desc-dash">Cab. Tebet Raya</p>
											<p class="desc-dash">No.Rek : 3276627272</p>
											<p class="desc-dash">A/n PT. Waterbe</p>
										</li>
										
										<li>
											<img src="img/bank_mandiri.gif" alt="HTML5 Icon" style="width:50px; height:30px;">
											<span class="glyphicon-class">Bank Mandiri</span>
											<p class="desc-dash">Cab. Tebet Raya</p>
											<p class="desc-dash">No.Rek : 3276627272</p>
											<p class="desc-dash">A/n PT. Waterbe</p>
										</li>
										...
										<li>
											<img src="img/bri.png" alt="HTML5 Icon" style="width:50px; height:30px;">
											<span class="glyphicon-class">Bank BRI</span>
											<p class="desc-dash">Cab. Tebet Raya</p>
											<p class="desc-dash">No.Rek : 3276627272</p>
											<p class="desc-dash">A/n PT. Waterbe</p>
										</li>
										...
										<li>
											<img src="img/bni.png" alt="HTML5 Icon" style="width:50px; height:30px;">
											<span class="glyphicon-class">Bank BNI</span>
											<p class="desc-dash">Cab. Tebet Raya</p>
											<p class="desc-dash">No.Rek : 3276627272</p>
											<p class="desc-dash">A/n PT. Waterbe</p>
										</li>
...
<!-- End of Container -->
	...
	<script>
	$('#myBid').on('shown.bs.modal', function () {
	  $('#myInput').focus()
	})
	</script>
