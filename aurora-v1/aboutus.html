		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<div class="style-header-notif">	
					<a href="buat_lelang_c2c_new.jsp" class="nav navbar-nav navbar_bf_login">Buat Lelang</a>
      		...
      		<div class="col-md-10 row-home">
				<div class="col-md-3 inner_cat" role="complementary">
					<nav class="bs-docs-sidebar">
						<p class="media-heading f14">Company Info</p>
						<ul class="nav bs-docs-sidenav"> 
							<li class="">
							  <a href="#whats" class="kategori-sidebar ListFaq"><i class="fa fa-quote-left fa-space"></i> What is waterbe</a>
							</li>
							<li class="">
							  <a href="#vision" class="kategori-sidebar ListFaq"> <i class="fa fa-line-chart fa-space"></i>Our Vision & Mission</a>
							</li>
							<li class="">
							  <a href="#howitworks" class="kategori-sidebar ListFaq"> <i class="fa fa-file-text fa-space"></i>How waterbe Works?</a>
							</li>
						</ul>
						<br><hr>
				...
				<div class="col-md-9" role="main">
					<div class="bs-docs-section bidaktif_SideRight">
						<div class="page-header nomargintop">
							<h4 id="whats" class="title-category">What is waterbe</h4>
							<small><cite>" Easiest way to buy, Highest price to sell "</cite></small>
						</div>
						<p class="aboutus_text">
							waterbe adalah situs pelelangan online yang bekerja layaknya broker untuk memasarkan barang lelang anda dan 
							mempertemukannya dengan banyak calon pembeli potensial, sehingga barang lelang yang anda jual dapat mencapai 
							harga yang kompetitif daripada pelelangan biasanya. 
							Kami membuat anda menjadi sangat mudah dalam menjual ataupun membeli barang lelang yang anda inginkan.
						</p>
						<p class="aboutus_text">
							Sebagai penjual, anda hanya cukup mengupload barang yang ingin anda lelang, lalu biarkan kami untuk meroketkan harga 
							jualnya dengan cara mendatangkan banyak calon pembeli potensial. Anda hanya cukup mengupload dan melakukan kontrol 
							terhadap lelang yang anda buat semudah menekan tombol pada layar handphone dan mendapatkan pemenang.
						</p>
						<p class="aboutus_text">
							Sebagai pembeli, kami menyediakan fasilitas yang lengkap dan super mudah untuk digunakan oleh anda dalam berperang 
							mendapatkan barang lelang yang anda inginkan. Kami menyediakan proses yang mudah dan aman, kami selalu dekat dengan 
							anda untuk menjadi asisten pribadi anda dalam menentukan bid dan selalu memberikan notifikasi terupdate mengenai 
							pelelangan yang anda ikuti. Kami memastikan tidak ada hal yang terlewatkan oleh anda, selama pelelangan berlangsung.
						</p>
						<small><cite>"We always commit to assist you and never sleep to serve your auction. "</cite></small>
					</div>
					<div class="bs-docs-section bidaktif_SideRight">
						<div class="page-header nomargintop">
							<h4 id="vision" class="title-category">Our Vision & Mission</h4>
						</div>
						<p class="aboutus_text">
							Kami percaya setiap orang maupun perusahaan mempunyai barang bekas yang masih layak untuk digunakan atau masih 
							mempunyai nilai manfaat. Kami mempunyai ambisi untuk membantu mereka yang ingin menjual barang-barang bekas 
							miliknya, namun tidak ingin menjualnya begitu saja.
						</p>
						<p class="aboutus_text">
							Misi kami adalah mempertemukan barang bekas anda ke pembeli yang tepat, dengan harga yang kompetitif dan semua 
							itu dilakukan dengan proses yang super mudah, aman dan menyenangkan.
						</p>
						<p class="aboutus_text">
							<i>Mimpi kami adalah membuat barang-barang bekas anda menjadi lebih bermanfaat.</i>
						</p>
					</div>
					<div class="bs-docs-section bidaktif_SideRight">
						<div class="page-header nomargintop">
							<h4 id="howitworks" class="title-category">How waterbe Works?</h4>
						</div>
					</div>
				</div>
			</div> 
