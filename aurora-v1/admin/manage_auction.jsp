...
<body>
	...
	<div id="page-wrapper" style="min-height: 363px;">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">Auction List</h3>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		...
		<div class="row">
			<div class="row" style="margin-bottom:30px;margin-left:-3px;">
				<div class="col-md-4" style="padding-right:0;padding-left: 3px;">
					<input type="text" class="form-control form-control_custom test-both" id="namaPerusahaan" placeholder="Auction Name / Category">
				</div>
				<div class="col-md-3" style="padding-right:0;padding-left: 3px;">
					<select class="form-control form-control_custom" style="font-size:13px;">
						...
						<option>Time (Closing Soon-Newest)</option>
						<option>Time (Newest-Closing Soon)</option>
						<option>Bid (Highest-Lowest)</option>
						<option>Bid (Lowest-Highest)</option>
						<option>Block</option>
					</select>
				</div>
			...
			<div class="table-responsive tablefont">
				<table class="table table-striped table-bordered table-hover f12">
					<thead>
						<tr>
							<th class="text-center">Auction Title</th>
							<th class="text-center">Opening Price</th>
					...
					<tbody>
						<tr>
							<th scope="row"><a href="view_auction.jsp">Kapal Tanker Pertamina Lokasi Ujung Berung</a></td>
							<td>15.000.000.000</td>
							<td>25.230.000.000</td>
							<td>44</td>
							<td>Active</td>
							<td><cite>9 hari 12 jam [13 April, 08:30 Wib]</cite></td>
							<td>Transportation</td>
							<td>100.000.000</td>
							<td>
								<a href="#" type="button" data-toggle="modal" data-target="#promote" class="btn btn-success btn-xs btn-action">Promote</a>
								<a href="#" type="button" data-toggle="modal" data-target="#block" class="btn btn-warning btn-xs btn-action">Block</a>
							</td>
						</tr>
						<tr>
							<th scope="row"><a href="#">Kapal Tanker Pertamina Lokasi Ujung Berung</a></td>
							<td>15.000.000.000</td>
							<td>25.230.000.000</td>
							<td>44</td>
							<td>Active</td>
