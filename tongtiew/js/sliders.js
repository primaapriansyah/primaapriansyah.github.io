...
$(document).ready(function() {
	...
	var hotDeal1 = $("#hot-deal-1");
 
	hotDeal1.owlCarousel({
	...
	$(".hotDeal1-next").click(function(){
		hotDeal1.trigger('owl.next');
	})
	$(".hotDeal1-prev").click(function(){
		hotDeal1.trigger('owl.prev');
	})
	
	/* Hot Deal 2 */
	
	var hotDeal2 = $("#hot-deal-2");
 
	hotDeal2.owlCarousel({
		...
		itemsMobile : [479,1], //1 items between 479px and 0
		pagination : false, //
		autoPlay: true, //autoPlay : 5000 to play every 5 seconds. If you set autoPlay: true default speed will be 5 seconds.
		lazyLoad : true
	});
	
	// Custom Navigation Events
	$(".hotDeal2-next").click(function(){
		hotDeal2.trigger('owl.next');
	})
	$(".hotDeal2-prev").click(function(){
		hotDeal2.trigger('owl.prev');
	})
	
	/* Hot Deal 2 */
	
	var hotDeal3 = $("#hot-deal-3");
 
	hotDeal3.owlCarousel({
		items : 3, //4 items above 1199px browser width
		itemsDesktop : [1199,3], //4 items between 1199px and 992px
		itemsDesktopSmall : [991,2], //3 betweem 991px and 768px
		itemsTablet: [767,1], //2 items between 767px and 478px
	...
	// Custom Navigation Events
	$(".hotDeal3-next").click(function(){
		hotDeal3.trigger('owl.next');
	})
	$(".hotDeal3-prev").click(function(){
		hotDeal3.trigger('owl.prev');
	})
	...
	// Custom Navigation Events
	$(".testimonialCarousel-next").click(function(){
		testimonialCarousel.trigger('owl.next');
	})
	$(".testimonialCarousel-prev").click(function(){
		testimonialCarousel.trigger('owl.prev');
	})
	
	/* Tweet Carousel */
	
	var tweetCarousel = $("#tweet-carousel");
	...
	// Custom Navigation Events
	$(".tweetCarousel-next").click(function(){
		tweetCarousel.trigger('owl.next');
	})
	$(".tweetCarousel-prev").click(function(){
		tweetCarousel.trigger('owl.prev');
	})
	...
	var owlSlider = $("#owl-slider");
		...
		autoPlay: 5000, //autoPlay : 5000 to play every 5 seconds. If you set autoPlay: true default speed will be 5 seconds.
		stopOnHover: true,
		lazyLoad : true
		
	});
	
	$(".owlSlider-next").click(function(){
		owlSlider.trigger('owl.next');
	})
	$(".owlSlider-prev").click(function(){
	...
	$(".owlSlider2-next").click(function(){
		owlSlider2.trigger('owl.next');
	})
	$(".owlSlider2-prev").click(function(){
		owlSlider2.trigger('owl.prev');
	})
	
	/* General Owl Slider */
	
	var owlSlider3 = $("#owl-slider-3");
	...
	$(".owlSlider3-next").click(function(){
		owlSlider3.trigger('owl.next');
	})
	$(".owlSlider3-prev").click(function(){
		owlSlider3.trigger('owl.prev');
	})
	
	var fullSizeImage = $("#full-size-image");
	var carouselThumb = $("#carousel-thumb");

	fullSizeImage.owlCarousel({
		singleItem : true,
		slideSpeed : 1000,
		navigation: true,
		pagination:false,
	...
	carouselThumb.owlCarousel({
		...
		el.find(".owl-item").eq(0).addClass("activing");
		}
	});
	...
	function syncPosition(el){
		...
		.eq(current)
		.addClass("activing")
		if($("#carousel-thumb").data("owlCarousel") !== undefined){
			center(current)
		}
	}

	$("#carousel-thumb").on("click", ".owl-item", function(e){
		e.preventDefault();
		var number = $(this).data("owlItem");
		fullSizeImage.trigger("owl.goTo",number);
	});
