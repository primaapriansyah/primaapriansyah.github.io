...
<div id="wrap">
    ...
    <div class="container-fluid container-content ">
			...
			<div class="col-md-10">
				<div class="row">
					<ol class="breadcrumb breadcrumb-style">
						...
						<li><a href="#">Lelang Saya</a></li>
						<li class="active">Lelang Terjual</li>
					</ol><!-- End Breadcrumb -->
				</div>
			</div>
			<div class="col-md-1"></div>
				...
				<div class="col-md-9" role="main">
					<div class="bs-docs-section bidaktif_SideRight">
						<div class="page-header nomargintop">
							<h4 id="whats" class="title-category">Lelang Terjual</h4>
						...
						<div class="media">
							...
							<div class="media-body">
								...
								<div class="btn-group btn-group-sm bidaktif_elapsed f11">
									<p class="bidaktif_elapseddet"><code>Status Pembayaran : Bidder Belum Bayar</code></p> 
								</div>
										...
										<div class="table-responsive">
											<table class="table f11">
												<tbody>
													...
													<tr>
														<td class="modif_td">Harga Pembuka</td>
														<td class="modif_td">: 5.100.000.000</td>
													</tr>
													<tr>
														<td class="modif_td">Bid Terakhir</td>
								...
								<a href="#" type="button" data-toggle="modal" data-target="#exampleModal" class="btn btn-success btn-sm">Konfirmasi Pengiriman Barang</a>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="exampleModalLabel">Konfirmasi Pengiriman</h4>
					</div>
					<div class="modal-body">
						<form>
							<div class="form-group">
								<label for="recipient-name" class="control-label">Nomor Pengiriman:</label>
								<input type="text" class="form-control" id="recipient-name">
							</div>
							<div class="form-group">
								<label for="message-text" class="control-label">Nama Pengirim:</label>
								<input type="text" class="form-control" id="recipient-name">
							</div>
							<div class="form-group">
								<label for="message-text" class="control-label">Tanggal Pengiriman:</label>
								<div class="row">
		...
		<!-- End of Modal Shipping Confirmation -->
