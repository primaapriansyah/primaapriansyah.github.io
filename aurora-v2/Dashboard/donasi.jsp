				...
				<div class="col-md-9" role="main">
					<div class="bs-docs-section bidaktif_SideRight">
						<div class="page-header nomargintop">
							<h4 id="whats" class="title-category">Donasi</h4>
							<small><cite>" Easiest way to buy, Highest price to sell "</cite></small>
						</div>
						
						<div class="row">
							<div class="col-sm-8 wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">
								<h4 class="column-title">Save the Childen</h4>
								<p>Save the Children invests in childhood-every day, in times of crisis and for our future. In the United States and around the world, we give children a healthy start, the opportunity to learn and protection from harm. By transforming children's lives now, 
									we change the course of their future and ours.</p>
								<a href="#">Lihat Profil Selengkapnya</a>
							</div>
							<div class="col-sm-4 wow fadeInLeft animated" style="visibility: visible; animation-name: fadeInLeft;">
								<img class="img-circle img-responsive img-center" src="../img/hope.jpg" alt="">
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<table class="table table-bordered table-striped table-hover table-donate">
								  ...
								  <tbody>
									<tr>
										<td><a href="#">Mobil Avanza thn 2013</a></td>
										<td>140.000.000</td>
										<td>10%</td>
										<td>14.000.000</td>
