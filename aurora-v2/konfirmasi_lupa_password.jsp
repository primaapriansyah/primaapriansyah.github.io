		...
		<div class="row">
			<div class="col-md-1"></div>
      		<div class="col-md-10 row-home">
      			<div class="bs-callout bs-callout-danger konfirmasi_fp" id="callout-badges-ie8-empty">
					<h4>Kami telah mengirimkan email ke alamat dena@astra.com.</h4><br>
					<p>Harap menunggu beberapa saat untuk melakukan pengecekan email tersebut dan mohon ikuti instruksi pada email yang kami kirim untuk dapat mereset password anda.</p>
					
					<p>Jika anda tidak menerima email kami pada inbox anda, mohon perhatikan folder junk atau spam pada alamat email anda</p>
					<div class="media-body fp_confirm">
					<p class="otheropsi-fp">Anda tidak dapat mengingat Email ataupun Username?</p>
					<ul class="nav">
						<li><a href="#"><i class="fa fa-phone fa-space"></i> Hubungi Customer Service kami</a></li>
						<li><a href="#"><i class="fa fa-envelope fa-space"></i>Buat Akun Baru</a></li>
					</ul>
				</div>
				</div>
