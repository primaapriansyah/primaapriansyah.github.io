		...
		<div class="row">
			<div class="col-md-1"></div>
      		<div class="col-md-10 row-home">
      			<div class="row">
					<div class="box-fp">
						<div class="box-headerfp">
							<h5 class="box-titlefp">Lupa Password?</h5>
						</div>
						<div class="box-bodyfp">
							<form class="form-horizontal">
								<p class="box-contentfp">Masukkan email atau username login Anda pada form dibawah ini. Kami akan mengirimkan email yang berisi link untuk melakukan Reset Password</p>
									...
									<a href="#" class="btn btn-primary btn col-md-offset-5 buttonreset_fp">Reset Password</a>
							</form>
						</div>
