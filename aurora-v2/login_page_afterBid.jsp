		...
		<div class="row">
			<div class="col-md-1"></div>
      		<div class="col-md-10 row-home">
				<div class="row">
					<div class="alert alert-warning" role="alert" style="padding-left: 75px; padding-top: 5px;">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">x</span></button>
						<i class="fa fa-key fa-lg icon-key"></i>
						<h5 class="warning-title">Anda belum melakukan login</h5>
						<p class="warning-content">Untuk dapat mengikuti pelelangan yang diinginkan, anda diwajibkan untuk login terlebih dahulu. </p>
					</div>
				</div>
				<div class="row style_loginreg">
					<div class="col-md-8">
						<form class="login_page">
							<h4 class="fontgreen">Login</h4><hr>
							<div class="form-group">
								<label for="exampleInputEmail1" class="label_style">Email</label>
								<input type="email" class="form-control" id="exampleInputEmail1" placeholder="Email">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1" class="label_style">Password Baru</label>
								<input type="password" class="form-control" id="exampleInputPassword1" placeholder="Password">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1" class="label_style">Ulangi Password Baru</label>
								<input type="password" class="form-control" id="exampleInputPassword1" placeholder="Password">
							</div>
							<label class="checkbox label_style reme">
								<input type="checkbox" value="remember-me">Remember me
							</label>
							<a href="#" class="btn_lp">Lupa Password? </a><span class="clearfix"></span>
							<a href="detail_lelang_c2c.jsp" type="submit" class="btn btn-primary btn">Login</a>
						</form>
					</div>
					<div class="col-md-3 reg_loginpage">
						<div class="media-body fp_confirm">
							<h3 class="text-center fontgreen">Daftar Waterbe?</h3>
							<p class="text-center">Daftar dan jadikan barang bekas anda lebih bermanfaat. <br>Prosesnya mudah dan cepat!</p>
							<br><br><a href="registrasi.jsp" class="btn btn-primary btn loginpage">Daftar</a>
						</div>
					</div>
				</div> 
