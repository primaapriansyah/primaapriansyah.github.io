			...
			<div class="col-md-10">
				...
				<div class="col-md-3 inner_cat" role="complementary">
					<nav class="bs-docs-sidebar">
						<p class="media-heading f14">Transportasi</p>
						<ul class="nav">
							<li class="list-active"><a href="#"><i class="fa fa-map-marker fa-space"></i>All Transportation</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-map-marker fa-space"></i>Car</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-phone fa-space"></i>Motorcycle</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-envelope fa-space"></i>Truck</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-envelope fa-space"></i>Bus</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-phone fa-space"></i>Forklift</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-envelope fa-space"></i>Aircraft</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-envelope fa-space"></i>Ship</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-envelope fa-space"></i>Others</a></li>
						</ul>
						<hr>
						<p class="media-heading f14 inner_cat_leftside">Kategori Lelang</p>
						<ul class="nav">
							<li class="list-active"><a href="#"><i class="fa fa-map-marker fa-space"></i>Semua Lelang</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-map-marker fa-space"></i>Lelang Popular</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-phone fa-space"></i>Lelang Akan Berakhir</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-envelope fa-space"></i>Lelang Cepat</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-envelope fa-space"></i>Lelang Amal</a></li>
						</ul>
					</nav>
				</div>
				<!-- End Inner Left Sidebar -->
				
				
				<!-- Inner Right Content -->
				<div class="col-md-9" role="main">
					<div class="bs-docs-section inner_zone">
						<div class="page-header nomargintop">
							<h4 id="whats" class="title-category">Transportasi</h4>
						</div>
						<div class="row">
