...
<div id="wrap">
    ...
    <div class="container-fluid container-content ">
		...
		<div class="row">
			...
			<div class="col-md-10">
				<ul class="bs-docs-footer-links text-muted breadcrumb-style" style="float:right;">
					  <li>Pencarian Terkait : </li>
					  <li><a href="#">Ferrari</a></li>
					  <li><a href="#">Avanza</a></li>
					  <li><a href="#">Toyota</a></li>
					  <li><a href="#">Honda</a></li>
					  <li><a href="#">Accesories Mobil</a></li>
					  <li><a href="#">Bemper mobil</a></li>
					</ul>
			</div>
			<div class="col-md-1"></div>
		</div>
		<!-- End of Search Related -->
      		...
      		<div class="col-md-10">
				...
				<div class="col-md-3 inner_cat" role="complementary">
					<nav class="bs-docs-sidebar">
						<p class="media-heading f14">Kategori Lelang</p>
						<ul class="nav">
							<li class="list-active"><a href="#"><i class="fa fa-clock-o fa-space"></i>Semua Pelelangan</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-clock-o fa-space"></i>Lelang Popular</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-envelope fa-space"></i>Lelang Akan Berakhir</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-envelope fa-space"></i>Lelang Cepat</a></li>
							<li><a href="#" class="kategori-sidebar"><i class="fa fa-phone fa-space"></i>Lelang Amal</a></li>
						</ul>
						<hr>
				...
				<!-- End Search Result Left Side -->
				
				<!-- Search Result Right Side -->
				<div class="col-md-9" role="main">
					<div class="bs-docs-section inner_zone">
						<div class="page-header nomargintop">
							<h4 id="whats" class="title-category">Hasil Pencarian <small><cite>Mobil (11.091 item)</cite></small></h4>
						</div>
						
						<!-- Search Result Form Search -->
						<div class="row searchres_form">
							<div class="col-md-3 searchres_opsi">
							...
							<div class="col-md-4 searchres_opsi">
								<select class="form-control form-control_custom f13">
									<option>Urutkan Pencarian</option>
									<option>Lelang Segera Berakhir</option>
									<option>Lelang Terbaru</option>
									<option>Jumlah Bid Terendah</option>
									<option>Jumlah Bid Tertinggi</option>
									<option>Harga Terendah</option>
									<option>Harga Tertinggi</option>
								</select>
							</div>
							<div class="col-md-1 searchres_opsi">
								<button type="button" class="btn btn-default searchres_btn">Cari</button>
							</div>
						</div>
						<!-- End of Search Result Form Search -->
