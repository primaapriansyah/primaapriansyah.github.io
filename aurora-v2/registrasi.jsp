    ...
    <div class="container-fluid container-content ">
		<div class="row">
			<div class="col-md-2"></div>
      		<div class="col-md-8 row-home">
				<div class="row style_loginreg">
					<form class="login_page reg_page">
						<div class="page-header reg_page_hdr">
							<h4 id="whats" class="title-category">Daftar</h4>
						</div>
						
						<div class="social-reg-custom social-login">Daftar dengan mengunakan &nbsp;
							<a href="" class="fb"><i class="fa fa-facebook"></i></a>
							<a href="" class="tw"><i class="fa fa-twitter"></i></a>
						</div>
						
						<div class="hr-label reg_lbl_email">
							<span class="hr-label__text"><p class="reg_lbl_email_text">Atau Daftar dengan email</p></span>
						</div>
							
						<div class="form-group">
							<label for="exampleInputEmail1" class="label_style">Nama Lengkap</label>
							<input type="text" class="form-control" id="namaLengkap" placeholder="Nama Lengkap">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1" class="label_style">Email</label>
							<input type="email" class="form-control" id="email" placeholder="Email">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1" class="label_style">Nomor Handphone</label>
							<input type="email" class="form-control" id="nomorHandphone" placeholder="Ex : 081298435511">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="exampleInputPassword1" class="label_style">Ulangi Password</label>
							<input type="password" class="form-control" id="exampleInputPassword1" placeholder="Password">
						</div>
						<div class="form-group">
							<label for="exampleInputPassword1" class="label_style">Kota</label>
						...
						<div class="form-group">
							<label for="exampleInputPassword1" class="label_style">Provinsi</label>
							<select class="form-control form-control_custom f13">
						...
						<div class="form-group reg_jenkel">
							<label for="exampleInputEmail1" class="label_style">Jenis Kelamin</label>
							<div>
						...
						<div class="form-group">
							<label for="exampleInputPassword1" class="label_style">Tanggal Lahir</label>
							<div class="row reg_tgl_row">
								<div class="col-md-4 reg_ttl">
									<select class="form-control form-control_custom f13">
						...
						<div class="checkbox">
							<label class="reg_policy"><input type="checkbox"> Saya setuju dengan <a href="#">Kebijakan AuctionParty</a></label>
						</div>
						
						<div class="form-group">
							<a href="detail_lelang_c2c.jsp" type="button" class="btn btn-primary btn-block">Daftar</a>
						</div>
						
					</form>
					<div class="social-login">Sudah Mendaftar? &nbsp;
						<button type="button" class="btn btn-success btn-xs">Masuk</button>
					</div>
				</div>
      		</div>
			<div class="col-md-2"></div>
