...
var Trafyt = window.Trafyt || {};

/* ==================================================
	Contact Form Validations
================================================== */
	Trafyt.ContactForm = function(){
...
$(window).load(function(){
	...
	$(".additional-images .owl-carousel .item-video").each(function(){
		$(this).append("<span class='icon'><i class='fa fa-play'></i></span>");z
	});
	Trafyt.StickyHeader();
});
